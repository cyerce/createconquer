...
public class TitaniumNiobiumFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TITANIUM_NIOBIUM_FLUID_TYPE = register("molten_titanium_niobium_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA17E9196, new Vector3f(126f / 255f, 145f / 255f, 150f/255f), properties));
    }
