...
public class StaballoyFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_STABALLOY_FLUID_TYPE = register("molten_staballoy_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1B2B2B2, new Vector3f(178f / 255f, 178f / 255f, 178f/255f), properties));
    }
