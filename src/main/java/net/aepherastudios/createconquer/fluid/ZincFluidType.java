...
public class ZincFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ZINC_FLUID_TYPE = register("molten_zinc_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1A5C0A0, new Vector3f(165f / 255f, 192f / 255f, 160f/255f), properties));
    }
