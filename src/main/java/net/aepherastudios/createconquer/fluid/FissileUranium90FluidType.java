...
public class FissileUranium90FluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_FISSILE_URANIUM_90_FLUID_TYPE = register("molten_fissile_uranium_90_fluid",
