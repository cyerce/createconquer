...
public class SteelFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_STEEL_FLUID_TYPE = register("molten_steel_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA18B8B8B, new Vector3f(139f / 255f, 139f / 255f, 139f/255f), properties));
    }
