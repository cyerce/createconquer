...
public class NiobiumFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_NIOBIUM_FLUID_TYPE = register("molten_niobium_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1606996, new Vector3f(96f / 255f, 105f / 255f, 150f/255f), properties));
    }
