...
public class ElectrumFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ELECTRUM_FLUID_TYPE = register("molten_electrum_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1CCC092, new Vector3f(204f / 255f, 192f / 255f, 146f/255f), properties));
    }
