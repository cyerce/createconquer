...
public class LeadFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_LEAD_FLUID_TYPE = register("molten_lead_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA166547C, new Vector3f(102f / 255f, 84f / 255f, 124f/255f), properties));
    }
