...
public class StainlessSteelFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_STAINLESS_STEEL_FLUID_TYPE = register("molten_stainless_steel_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1B8B8B8, new Vector3f(184f / 255f, 184f / 255f, 184f/255f), properties));
    }
