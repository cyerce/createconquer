...
public class SiliconFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_SILICON_FLUID_TYPE = register("molten_silicon_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1606060, new Vector3f(96f / 255f, 96f / 255f, 96f/255f), properties));
    }
