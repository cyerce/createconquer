...
public class ChromiumFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_CHROMIUM_FLUID_TYPE = register("molten_chromium_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1A4CED2, new Vector3f(164f / 255f, 206f / 255f, 210f/255f), properties));
    }
