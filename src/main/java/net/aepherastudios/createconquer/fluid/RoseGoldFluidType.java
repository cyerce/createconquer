...
public class RoseGoldFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ROSE_GOLD_FLUID_TYPE = register("molten_rose_gold_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1C19696, new Vector3f(193f / 255f, 150f / 255f, 150f/255f), properties));
    }
