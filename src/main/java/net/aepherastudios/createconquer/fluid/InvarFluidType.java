...
public class InvarFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_INVAR_FLUID_TYPE = register("molten_invar_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1BFBFAA, new Vector3f(191f / 255f, 191f / 255f, 170f/255f), properties));
    }
