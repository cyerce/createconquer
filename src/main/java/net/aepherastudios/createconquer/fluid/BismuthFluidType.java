...
public class BismuthFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BISMUTH_FLUID_TYPE = register("molten_bismuth_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA16A7869, new Vector3f(106f / 255f, 120f / 255f, 105f/255f), properties));
    }
