...
public class PlutoniumFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_PLUTONIUM_FLUID_TYPE = register("molten_plutonium_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1929292, new Vector3f(146f / 255f, 146f / 255f, 146f/255f), properties));
    }
