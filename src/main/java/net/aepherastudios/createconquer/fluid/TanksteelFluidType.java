...
public class TanksteelFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TANKSTEEL_FLUID_TYPE = register("molten_tanksteel_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA196A9AE, new Vector3f(150f / 255f, 169f / 255f, 174f/255f), properties));
    }
