...
public class BrassFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_BRASS_FLUID_TYPE = register("molten_brass_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1FBCC68, new Vector3f(251f / 255f, 204f / 255f, 104f/255f), properties));
    }
