...
public class NetheriteFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_NETHERITE_FLUID_TYPE = register("molten_netherite_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA13B393B, new Vector3f(59f / 255f, 57f / 255f, 59f/255f), properties));
    }
