...
public class AlnicoFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_ALNICO_FLUID_TYPE = register("molten_alnico_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1C3BCA3, new Vector3f(195f / 255f, 188f / 255f, 163f/255f), properties));
    }
