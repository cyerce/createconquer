...
public class FissileUranium20FluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_FISSILE_URANIUM_20_FLUID_TYPE = register("molten_fissile_uranium_20_fluid",
