...
public class SilverFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_SILVER_FLUID_TYPE = register("molten_silver_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA19F9F9F, new Vector3f(159f / 255f, 159f / 255f, 159f/255f), properties));
    }
