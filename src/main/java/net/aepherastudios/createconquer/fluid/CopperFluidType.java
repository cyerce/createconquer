...
public class CopperFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_COPPER_FLUID_TYPE = register("molten_copper_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA1DA6252, new Vector3f(218f / 255f, 98f / 255f, 82f/255f), properties));
    }
