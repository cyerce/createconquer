...
public class TinFluidType {
    ...
    public static final RegistryObject<FluidType> MOLTEN_TIN_FLUID_TYPE = register("molten_tin_fluid",
    ...
    private static RegistryObject<FluidType> register(String name, FluidType.Properties properties) {
        return FLUID_TYPES.register(name, () ->
                new BaseFluidType(MOLTEN_METAL_STILL_RL, MOLTEN_METAL_FLOWING_RL, MOLTEN_METAL_OVERLAY_RL, 0xA171878D, new Vector3f(113f / 255f, 135f / 255f, 141f/255f), properties));
    }
